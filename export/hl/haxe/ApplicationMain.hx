...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DhavalThanki_Assignment1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DhavalThanki_Assignment1", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "DhavalThanki_Assignment1";
		app.meta["name"] = "DhavalThanki_Assignment1";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "DhavalThanki_Assignment1",
			width: 640,
			x: null,
			y: null,
		};
